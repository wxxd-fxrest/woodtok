...
class _ActivityScreenState extends State<ActivityScreen>
  ...
  late final Animation<Color?> _barrierAnimaiton = ColorTween(
        ...
        children: [
          ...
          if (_showBarrier)
            AnimatedModalBarrier(
              color: _barrierAnimaiton,
              dismissible: true,
              onDismiss: _toggleAnimaions,
            ),
          SlideTransition(
